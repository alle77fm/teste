<!DOCTYPE html>
    ...
    <img src="assets/logo.png" height="180px" width="180px" id="logo">
  </div>
  ...
  <div class="container" id="container_cadastro">
    ...
    <div id="tela_cadastrar" class="classe_da_tela" style="background-color: #ffffff; height: auto; width: 100%;">
      <span class="meu_texto" id="logar_lbl" style="font-size: 16px; color: #000000;  "><?php echo ("<span style='color:#ffffff;'>".'Ja tem Cadastro? '."</span>" . "<span style='color:#ff9900;'>".' ENTRAR'."</span>") ; ?></span>
    </div>
  </div>
