...
// Descreva esta função...
function enviar_msg() {
  ajax_post_async((String(url_principal) + 'insere_msg.php'), {telefone:telefone_cliente, senha:senha_cliente, msg:$("#msg-box").val()}, busca_msgs);
  $("#msg-box").val('');
}
...
//feito com bootblocks.com.br
  ...
  $("#tela_icon_cabecalho").css("background-color", "#272525");
  $("#cabecalho_msg").css("background-color", "#272525");
  $("#txt_cabecalho").css("background-color", "#272525");
