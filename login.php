...
?>
  ...
  <div id="tela_logo" class="tela-logins" style="background-color: #ffffff; height: 100%; width: 100%;">
    <img src="assets/logo.png" height="220px" width="220px" id="logo">
  </div>
  <div id="tela_text_box" class="tela-logins" style="background-color: #ffffff; height: auto; width: 100%;">
    <p style="color: #ff9900; font-size: 16px; font-weight: bold; ">ENTRAR</p></div>
  ...
  <div class="container" id="login">
    ...
    <button type="button" onclick="login()" id='logar_btn' class="btn btn-warning"><strong>Entrar<strong></button>
    <div style="width:10px;height:20px;"></div>
    <div id="tela_cadastrar" class="classe_da_tela" style="background-color: #ffffff; height: auto; width: 100%;">
      <span class="meu_texto" id="cadastrar_lbl" style="font-size: 16px; color: #000000;  "><?php echo ("<span style='color:#ffffff;'>".'Não tem Cadastro? '."</span>" . "<span style='color:#ff9900;'>".'CADASTRAR'."</span>") ; ?></span>
    </div>
  </div>
